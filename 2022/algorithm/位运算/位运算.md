...
<blockquote> 
<li><p><a href="https://leetcode.cn/problems/hamming-distance/" target="_blank">461. 汉明距离</a></p>
<li><p><a href="https://leetcode.cn/problems/missing-number/" target="_blank">268. 丢失的数字</a></p></li>
<ul><li><p><a href="https://leetcode.cn/problems/single-number/" target="_blank">136. 只出现一次的数字</a></p>
<li><p><a href="https://leetcode.cn/problems/single-number-ii/" target="_blank">137. 只出现一次的数字 II</a></p></li></ul>
<li><p><a href="https://leetcode.cn/problems/single-number-iii/" target="_blank">260. 只出现一次的数字 III</a></p></li></ul>
<li><p><a href="https://leetcode.cn/problems/reverse-bits/" target="_blank">190. 颠倒二进制位</a></p></li></ul>
</blockquote> 
...
class Solution:
    def singleNumber(self, nums: List[int]) -> List[int]:
        ...
        for num in nums:            # 异或运算，目的是找到两个落单数值的不同，便于后面分类
            mask ^= num
        mask  &= (-mask)            # 找到二者最后一位的不同，将这一位定为分类依据
        type1, type2 = 0, 0         
